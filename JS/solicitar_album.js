    ...
    for(c = 1; c <= 6; c++) {
        ...
        switch(c){
            case 1:
                ...
                break;
            case 2:
                celda.textContent = f*3;
                break;
            case 3:
                if(f<5)
                    celda.textContent = (f*0.10).toFixed(2);
                else if(f>=5 && f<=11)
                    celda.textContent = ((4*0.10)+((f-4)*0.08)).toFixed(2);
                else
                    celda.textContent = ((4*0.10)+(7*0.08)+((f-11)*0.07)).toFixed(2);
                break;
            case 4:
                if(f<5)
                    celda.textContent = ((f*0.10)+(0.02*f*3)).toFixed(2);
                else if(f>=5 && f<=11)
                    celda.textContent = (((4*0.10)+((f-4)*0.08))+(0.02*f*3)).toFixed(2);
                else
                    celda.textContent = (((4*0.10)+(7*0.08)+((f-11)*0.07))+(0.02*f*3)).toFixed(2);
                break;
            case 5:
                if(f<5)
                    celda.textContent = ((f*0.10)+(0.05*f*3)).toFixed(2);
                else if(f>=5 && f<=11)
                    celda.textContent = (((4*0.10)+((f-4)*0.08))+(0.05*f*3)).toFixed(2);
                else
                    celda.textContent = (((4*0.10)+(7*0.08)+((f-11)*0.07))+(0.05*f*3)).toFixed(2);
                break;
            case 6:
                if(f<5)
                    celda.textContent = ((f*0.10)+(0.02*f*3)+(0.05*f*3)).toFixed(2);
                else if(f>=5 && f<=11)
                    celda.textContent = (((4*0.10)+((f-4)*0.08))+(0.02*f*3)+(0.05*f*3)).toFixed(2);
                else
                    celda.textContent = (((4*0.10)+(7*0.08)+((f-11)*0.07))+(0.02*f*3)+(0.05*f*3)).toFixed(2);
                break;
        }
    }
}